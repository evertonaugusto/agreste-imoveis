...
<body>
    <nav class="bg-orange-500 h-16">
        <div class="max-w-7xl h-full mx-auto flex justify-between items-center px-10">
            <div class="w-20 h-14" style="background-image: url('{{ asset('storage/logo.png') }}');
            ...
            <div class="flex gap-5 items-center">
                ...
                <div class="bg-white text-orange-500 px-4 py-2 rounded-full hover:bg-gray-100 cursor-pointer">
                    <a href="{{ route('imoveis.create') }}">ANUNCIAR</a>
                </div>
